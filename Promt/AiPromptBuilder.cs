...
namespace frontAIagent.Promt
{
    ...
    public class AiPromptBuilder : IAiPromptBuilder
    {
            ...
            string? logs = null)
        {
            ...
            sb.AppendLine();
            sb.AppendLine("4) **Красивый Markdown-блок с изменениями**, строго в одном из форматов:");
            sb.AppendLine();
            sb.AppendLine("   — ```diff");
            ...
            sb.AppendLine("\"Этот запрос не относится к проекту. Я работаю только в контексте текущего кода.\"");
            sb.AppendLine();
            sb.AppendLine("Язык: русский. Формат: структурированный, читаемый, аккуратный Markdown.");
            sb.AppendLine();
